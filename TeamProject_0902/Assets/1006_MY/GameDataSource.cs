...
public class GameDataSource : MonoBehaviour
{
    ...
    [SerializeField]
    private ChampionClass[] m_CharacterData;

    [Tooltip("All ActionDescription data should be slotted in here")]
    [SerializeField]
    private ActionDescription[] m_ActionData;

    private Dictionary<GameConsts.CharacterTypeEnum, ChampionClass> m_CharacterDataMap;
    ...
    /// </summary>
    public Dictionary<GameConsts.CharacterTypeEnum, ChampionClass> CharacterDataByType
    {
        get
        {
            if (m_CharacterDataMap == null)
            {
                m_CharacterDataMap = new Dictionary<GameConsts.CharacterTypeEnum, ChampionClass>();
                foreach (ChampionClass data in m_CharacterData)
                {
