...
public class ActionBar : MonoBehaviour
{
    ...
    {
        UpdateActionButton(m_ButtonInfo[ActionButtonType.Ability1], m_NetState.CharacterClass.Skill1);
        UpdateActionButton(m_ButtonInfo[ActionButtonType.Ability2], m_NetState.CharacterClass.Skill2);
        UpdateActionButton(m_ButtonInfo[ActionButtonType.Ability3], m_NetState.CharacterClass.Skill3);
        UpdateActionButton(m_ButtonInfo[ActionButtonType.Ability4], m_NetState.CharacterClass.Skill4);
        UpdateActionButton(m_ButtonInfo[ActionButtonType.Ability5], m_NetState.CharacterClass.Skill5);
