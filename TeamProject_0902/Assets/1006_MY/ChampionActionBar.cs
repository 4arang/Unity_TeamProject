...
public class ChampionActionBar : MonoBehaviour
{
    [SerializeField]
    ...
    class ActionButtonInfo
    {
        ...
        readonly ChampionActionBar m_Owner;

        public ActionButtonInfo(ActionButtonType type, UIHUDButton button, ChampionActionBar owner)
        {
            Type = type;
            Button = button;
