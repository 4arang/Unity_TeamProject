...
public class Nexus_Spawn : MonoBehaviour
{
    ...
    void SpawnMinion()
    {
        ...
        {
            Instantiate(minion1, new Vector3(transform.position.x + spawnOffset * 2, transform.position.y, transform.position.z), Quaternion.identity);
            Instantiate(minion1, new Vector3(transform.position.x + spawnOffset * 1, transform.position.y, transform.position.z), Quaternion.identity);

            Instantiate(minion2, new Vector3(transform.position.x, transform.position.y, transform.position.z), Quaternion.identity);
